...
2. Decide what to name your first server. A very sensible name is `“Server 1”`. Copy the example .json file into `C:/A3Servers/` and rename it to `“server1.json”`. Your two files should look like this: ![image-20201206071246053](https://github.com/ralian/a3-script-utils/blob/main/README.assets/image-20201206071246053.png?raw=true)
...
6. At this point your file should look like this: ![image-20201206065955918](https://github.com/ralian/a3-script-utils/blob/main/README.assets/image-20201206065955918.png?raw=true)
